...
# ============================================================================
# build-animus-docker.sh — build Docker image containing compiled Animus daemon
#
# Usage:
#   ./build-animus-docker.sh [tag]
#
# Environment variables:
#   REGISTRY_USER  Docker Hub / registry username (default: mrsommer)
#   IMAGE_NAME     Image name (default: animus)
