export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: 'ערוצים במעקב',
        monitoredChannelsHint: 'מזהי ערוצים למעקב הקשר (אחד בכל שורה). הודעות נרשמות מבלי להפעיל תגובות.',
        respondToDm: 'הגיבו להודעות DM',
        respondToMentions: 'הגיבו לאזכורים',
        monitorAllChannels: 'עקוב אחר כל הערוצים',
        respondToChannels: 'הגב על כל הודעה בערוצים במעקב',
