export const templates = {
  categories: {
    personal: {
      title: 'ផ្ទាល់ខ្លួន',
      description: 'ការប្រើប្រាស់ផ្ទះនិងឯកជន ផ្តោតលើអ្នកប្រើម្នាក់ឬក្រុមមិនផ្លូវការ។',
    },
    enterprise: {
      title: 'សហគ្រាស',
      description: 'សាងសង់បញ្ញាសិប្បនិមិត្តដែលបានរចនាឡើងដើម្បីគាំទ្រដល់អាជីវកម្មឬអង្គការ។',
    },
    advanced: {
      title: 'ប្រព័ន្ធកម្រិតខ្ពស់',
      description: 'សាងសង់បញ្ញាសិប្បនិមិត្ផច្រំធ្ងន់ដែលបានរចនាឡើងដើម្បីគាំទ្រដល់ការអភិវឌ្ឍន៍បច្ចេកវិទ្យានិងប្រតិបត្តិការ។',
    },
  },
...
Log your decisions and their outcomes. When something works well, the record should be reproducible. When something fails, the record should be diagnostic.`,
  ...
  // Wizard UI strings
  wizard: {
    stepTitle: 'ជ្រើសរើសគំរូ',
    stepHint: 'ជ្រើសរើសចំណុចចាប់ផ្តើមសម្រាប់ភ្នាក់ងាររបស់អ្នក។ អ្នកអាចប្តូរតាមចិត្តយកអ្វីៗទាំងអស់នៅពេលក្រោយ។',
    categoryStep: 'ភ្នាក់ងារនេះនឹងធ្វើអ្វី?',
    templateStep: 'ជ្រើសរើសគំរូ',
    categoryLabel: 'ប្រភេទ',
    templateLabel: 'គំរូ',
    useTemplate: 'ប្រើគំរូនេះ',
    skipTemplate: 'ចាប់ផ្តើមពីដើម',
    blank: 'ភ្នាក់ងារទទេ',
    blankDescription: 'ចាប់ផ្តើមជាមួយភ្នាក់ងារទទេ។ គ្មានគំរូ គ្មានអត្តសញ្ញាណកំណត់ជាមុន។',
  },
} as const;
