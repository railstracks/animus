export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: 'Kênh theo dõi',
        monitoredChannelsHint: 'ID kênh để theo dõi ngữ cảnh (mỗi dòng một ID). Tin nhắn được ghi lại mà không kích hoạt phản hồi.',
        respondToDm: 'Trả lời DM',
        respondToMentions: 'Trả lời đề cập',
        monitorAllChannels: 'Theo dõi tất cả kênh',
        respondToChannels: 'Phản hồi mọi tin nhắn trong kênh theo dõi',
