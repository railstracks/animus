export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: 'Canales rastreados',
        monitoredChannelsHint: 'IDs de canales a rastrear para contexto (uno por línea). Los mensajes se registran sin activar respuestas.',
        respondToDm: 'Responder a los DM',
        respondToMentions: 'Responder a las menciones',
        monitorAllChannels: 'Rastrear todos los canales',
        respondToChannels: 'Responder a cualquier mensaje en canales rastreados',
