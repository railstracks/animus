export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: 'القنوات المتتبعة',
        monitoredChannelsHint: 'معرفات القنوات لتتبع السياق (واحد لكل سطر). يتم تسجيل الرسائل دون تشغيل الردود.',
        respondToDm: 'الرد على الرسائل المباشرة',
        respondToMentions: 'الرد على الإشارات',
        monitorAllChannels: 'تتبع جميع القنوات',
        respondToChannels: 'الرد على أي رسالة في القنوات المتتبعة',
