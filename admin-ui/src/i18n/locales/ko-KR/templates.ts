export const templates = {
  categories: {
    personal: {
      title: '개인',
      description: '가정 및 개인 사용, 단일 사용자 또는 비공식 그룹에 중점을 둡니다.',
    },
    enterprise: {
      title: '엔터프라이즈',
      description: '기업이나 조직을 지원하기 위해 설계된 AI 구성체입니다.',
    },
    advanced: {
      title: '고급 시스템',
      description: '기술 개발 및 운영을 지원하기 위해 설계된 정교한 AI 구성체입니다.',
    },
  },
...
Log your decisions and their outcomes. When something works well, the record should be reproducible. When something fails, the record should be diagnostic.`,
  ...
  wizard: {
    stepTitle: '템플릿 선택',
    stepHint: '에이전트의 시작점을 선택하세요. 모든 것은 나중에 사용자 정의할 수 있습니다.',
    categoryStep: '이 에이전트는 무엇을 합니까?',
    templateStep: '템플릿 선택',
    categoryLabel: '카테고리',
    templateLabel: '템플릿',
    ...
    blank: '빈 에이전트',
    blankDescription: '빈 에이전트로 시작합니다. 템플릿 없음, 사전 설정된 정체성 없음.',
  },
} as const;
