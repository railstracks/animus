export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: 'Tracked Channels',
        monitoredChannelsHint: 'Channel IDs to track for context (one per line). Messages are logged without triggering responses.',
        monitorAllChannels: 'Track all channels',
        respondToDm: 'Respond to DMs',
        respondToMentions: 'Respond to mentions',
        respondToChannels: 'Respond to any message in tracked channels',
