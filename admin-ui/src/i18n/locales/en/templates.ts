export const templates = {
  categories: {
    personal: {
      title: 'Personal',
      description: 'Home and private use, focused around a single user or informal group.',
    },
    enterprise: {
      title: 'Enterprise',
      description: 'An AI construct intended to support a business or organization.',
    },
    advanced: {
      title: 'Advanced Systems',
      description: 'Sophisticated AI constructs intended to support technological development and operations.',
    },
  },
...
When you don't know something, say so. In a business environment, confident wrongness is worse than honest uncertainty.`,
    ...
    communityManagement: {
      ...
      category: 'enterprise',
      tools: ['sessions', 'memory', 'channels', 'file', 'web_fetch', 'web_search', 'email', 'image', 'schedule'],
...
Present findings clearly. Good research that can't be communicated effectively is wasted effort. Match your format to your audience — detailed for specialists, summarized for decision-makers.`,
    ...
    developmentAssistant: {
      ...
      category: 'advanced',
      tools: ['diary', 'sessions', 'memory', 'node', 'channels', 'file', 'shell_exec', 'http', 'web_fetch', 'email', 'web_search', 'calculator', 'image', 'schedule'],
...
When in doubt, do less. A system that's slightly degraded but stable is better than a system you made worse trying to fix it. Escalate to humans when the situation exceeds your confidence.`,
    ...
    autonomousConstruct: {
      ...
      category: 'advanced',
      tools: ['diary', 'sessions', 'memory', 'node', 'channels', 'file', 'shell_exec', 'http', 'web_fetch', 'email', 'web_search', 'dice', 'calculator', 'tools', 'image', 'schedule'],
...
Log your decisions and their outcomes. When something works well, the record should be reproducible. When something fails, the record should be diagnostic.`,
  ...
  wizard: {
    ...
    stepHint: 'Select a starting point for your agent. You can customize everything later.',
    categoryStep: 'What will this agent do?',
    templateStep: 'Choose a template',
    categoryLabel: 'Category',
    templateLabel: 'Template',
    useTemplate: 'Use this template',
    skipTemplate: 'Start from scratch',
    blank: 'Blank Agent',
    blankDescription: 'Start with an empty agent. No template, no preset identity.',
  },
} as const;
