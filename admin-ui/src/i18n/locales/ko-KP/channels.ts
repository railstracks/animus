export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: '추적 채널',
        monitoredChannelsHint: '컨텍스트를 위해 추적할 채널 ID (한 줄에 하나). 응답을 트리거하지 않고 메시지가 기록됩니다.',
        respondToDm: 'DM에 응답하기',
        respondToMentions: '멘션에 응답',
        monitorAllChannels: '모든 채널 추적',
        respondToChannels: '추적 채널의 모든 메시지에 응답',
