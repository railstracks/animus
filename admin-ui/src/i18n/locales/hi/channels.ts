export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: 'ट्रैक किए गए चैनल',
        monitoredChannelsHint: 'संदर्भ के लिए ट्रैक करने हेतु चैनल ID (प्रति पंक्ति एक)। संदेश लॉग होते हैं बिना प्रतिक्रिया ट्रिगर किए।',
        respondToDm: 'डीएम को जवाब दें',
        respondToMentions: 'उल्लेखों पर प्रतिक्रिया दें',
        monitorAllChannels: 'सभी चैनल ट्रैक करें',
        respondToChannels: 'ट्रैक किए गए चैनलों में किसी भी संदेश का उत्तर दें',
        dmWhitelistEnabled: 'DM को अनुमत उपयोगकर्ताओं तक सीमित करें',
        allowedDmUsers: 'अनुमत DM उपयोगकर्ता',
        allowedDmUsersHint: 'Discord उपयोगकर्ता नाम (प्रति पंक्ति एक)। केवल इन उपयोगकर्ताओं के लिए बॉट को DM भेजने की अनुमति है।'
      },
      slack: {
