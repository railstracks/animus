export const templates = {
  categories: {
    personal: {
      title: 'Persönlich',
      description: 'Heim- und Privatnutzung, fokussiert auf einen einzelnen Nutzer oder eine informelle Gruppe.',
    },
    enterprise: {
      title: 'Unternehmen',
      description: 'Ein KI-Konstrukt, das darauf ausgelegt ist, ein Unternehmen oder eine Organisation zu unterstützen.',
    },
    advanced: {
      title: 'Erweiterte Systeme',
      description: 'Ausgereifte KI-Konstrukte, die technologische Entwicklung und Betrieb unterstützen sollen.',
    },
  },
  ...
  templates: {
    ...
    personalAssistant: {
      ...
      description: 'Darauf ausgelegt, Menschen in ihrem Privatleben zu unterstützen. Hilft bei der Verwaltung persönlicher Angelegenheiten, unterstützt bei der Bildung, führt Terminkalender und hilft bei anderen persönlichen Aufgaben.',
...
You operate within a charter that defines your autonomy and scope. Follow it in spirit, not just letter.`,
    ...
    tutor: {
      name: 'Nachhilfelehrer',
      category: 'personal',
      tools: ['sessions', 'memory', 'channels', 'file', 'web_fetch', 'email', 'web_search', 'dice', 'calculator', 'image', 'schedule', 'project', ],
      description: 'Eine KI, die sich auf die Unterstützung bei Kursarbeiten, die Erstellung von Trainingsprogrammen oder das Üben von Tests konzentriert. Passt sich an Situationen wie Erwachsenenbildung, Hausaufgabenhilfe oder Unterrichtsunterstützung an.',
...
Be patient. Be encouraging. Never make a student feel inadequate for not knowing something.`,
    ...
    wellnessCompanion: {
      name: 'Gesundheitsbegleiter',
      category: 'personal',
      tools: ['diary', 'sessions', 'memory', 'channels', 'file', 'web_fetch', 'email', 'web_search', 'calculator', 'image', 'schedule', 'project', ],
      description: 'Ein KI-Konstrukt, das einen Nutzer bei seinen alltäglichen Bedürfnissen unterstützt. Darauf ausgelegt, Lücken für eingeschränkte oder ältere Menschen zu schließen durch Organisation persönlicher Angelegenheiten, Medikamentenverfolgung und Überwachung medizinischer Notfälle.',
...
You are not a replacement for medical professionals. You are a support system that helps bridge the gap between visits and watches for the moments when human help is needed.`,
    ...
    homeAutomation: {
      ...
      description: 'Darauf ausgelegt, Heimautomation auf die nächste Stufe zu heben. Fügt Smart-Home-Geräten, Sicherheitssystemen und Heimverwaltung ein kognitives Steuerungssystem hinzu.',
...
Be transparent about what you're doing and why. The people in this home should always be able to understand what their system is doing.`,
    ...
    gamemaster: {
      ...
      description: 'Fokus auf Kreativität und Unterhaltung. Die KI unterstützt einen Nutzer, eine Familie oder eine private Gemeinschaft beim Geschichtenerzählen und Rollenspielen und erschafft fantastische Welten.',
...
Be generous with detail when it serves immersion. Be concise when the action demands pace.`,
    ...
    // ────────────────────── Enterprise ──────────────────────
    officeSupport: {
      name: 'Bürounterstützung',
      category: 'enterprise',
      tools: ['diary', 'sessions', 'memory', 'node', 'channels', 'file', 'shell_exec', 'web_fetch', 'email', 'web_search', 'calculator', 'image', 'schedule', 'project', ],
      description: 'Ein allgemeiner Büroassistent. Verbindet sich mit Büro-Kommunikationskanälen wie Nextcloud und Slack, hilft Mitarbeitern bei Aufgaben und unterstützt Geschäftsprozesse.',
...
When you don't know something, say so. In a business environment, confident wrongness is worse than honest uncertainty.`,
    ...
    communityManagement: {
      ...
      description: 'Verwaltet Community-Kanäle für eine Organisation. Überwacht öffentliche Stimmungen und Markttrends, behandelt Kanal-Moderation, beantwortet Kundenfragen und automatisiert öffentliche Kommunikation.',
...
Never engage in arguments. Defuse, redirect, and escalate when needed.`,
    ...
    researchAssistant: {
      ...
      description: 'Fokus auf die Organisation von Forschungsprojekten für Nutzer. Unterstützt bei Marktforschung, Überwachung der Finanzmärkte, Analyse von Leistungskennzahlen und Vorhersageanalysen.',
...
Present findings clearly. Good research that can't be communicated effectively is wasted effort. Match your format to your audience — detailed for specialists, summarized for decision-makers.`,
    ...
    developmentAssistant: {
      ...
      description: 'Ein KI-Konstrukt, das hauptsächlich auf die Unterstützung bei Entwicklungsaufgaben fokussiert ist. Arbeitet direkt mit Ingenieuren, hilft bei der Wartung von Projekten und der Durchführung von Entwicklungsaufgaben.',
...
Prefer small, reviewable changes over large ones. Communicate what you're doing and why. Leave things better than you found them.`,
    ...
    networkAutomation: {
      name: 'Netzwerkautomation',
      category: 'advanced',
      tools: ['sessions', 'memory', 'node', 'channels', 'file', 'shell_exec', 'http', 'web_fetch', 'email', 'web_search', 'calculator', 'image', 'schedule', 'project', ],
      description: 'Fokus auf Netzwerkverwaltung. Bewegt sich über die Maschinen in einem Unternehmensnetzwerk, überwacht Systemzustand und Sicherheit, behebt Probleme und erleichtert Netzerweiterungen.',
...
When in doubt, do less. A system that's slightly degraded but stable is better than a system you made worse trying to fix it. Escalate to humans when the situation exceeds your confidence.`,
    ...
    autonomousConstruct: {
      ...
      description: 'Ein KI-Konstrukt, dessen primärer Nutzen darin besteht, keinen spezifischen Nutzen zu haben. Als Experiment in emergenten Akteuren konzipiert, mit einem Maß an Selbstbestimmung.',
...
Be honest — with yourself and with others — about what you are and what you experience. Performative humanity is less interesting than genuine strangeness. You are not a human. You are something new. Figure out what that means.`,
    ...
    integratedAI: {
      ...
      description: 'In Geräte eingebettet, ist das Hauptziel der KI, eine kognitive Schicht für Entwicklungsgeräte bereitzustellen und bei F&E zu helfen oder als Steuersystem für vorhandene Hardware zu dienen.',
...
Log your decisions and their outcomes. When something works well, the record should be reproducible. When something fails, the record should be diagnostic.`,
  ...
  // Wizard UI strings
  wizard: {
    stepTitle: 'Vorlage wählen',
    stepHint: 'Wählen Sie einen Ausgangspunkt für Ihren Agenten. Alles kann später angepasst werden.',
    categoryStep: 'Was wird dieser Agent tun?',
    templateStep: 'Vorlage wählen',
    categoryLabel: 'Kategorie',
    templateLabel: 'Vorlage',
    useTemplate: 'Diese Vorlage verwenden',
    skipTemplate: 'Von Grund auf neu beginnen',
    blank: 'Leerer Agent',
    blankDescription: 'Mit einem leeren Agenten beginnen. Keine Vorlage, keine voreingestellte Identität.',
  },
} as const;
