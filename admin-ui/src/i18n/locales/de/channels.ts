export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: 'Verfolgte Kanäle',
        monitoredChannelsHint: 'Kanal-IDs zum Verfolgen für Kontext (eine pro Zeile). Nachrichten werden protokolliert ohne Antworten auszulösen.',
        respondToDm: 'Auf Direktnachrichten antworten',
        respondToMentions: 'Reagieren Sie auf Erwähnungen',
        monitorAllChannels: 'Alle Kanäle verfolgen',
        respondToChannels: 'Auf jede Nachricht in verfolgten Kanälen antworten',
        dmWhitelistEnabled: 'DMs auf erlaubte Benutzer einschränken',
        allowedDmUsers: 'Erlaubte DM-Benutzer',
        allowedDmUsersHint: 'Discord-Benutzernamen (einer pro Zeile). Nur diese Benutzer können dem Bot DMs senden.'
      },
      slack: {
