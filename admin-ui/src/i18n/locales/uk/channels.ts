export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: 'Відстежувані канали',
        monitoredChannelsHint: 'ID каналів для відстеження контексту (по одному на рядок). Повідомлення записуються без запуску відповідей.',
        respondToDm: 'Відповідайте на DM',
        respondToMentions: 'Відповідайте на згадки',
        monitorAllChannels: 'Відстежувати всі канали',
        respondToChannels: 'Відповідати на будь-яке повідомлення у відстежуваних каналах',
