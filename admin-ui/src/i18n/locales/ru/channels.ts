export const channels = {
    ...
    form: {
      ...
      bluesky: {
        ...
        pds: 'URL-адрес PDS',
        enablePosts: 'Включить посты',
        enableDm: 'Включить DM',
      ...
      discord: {
        ...
        monitoredChannels: 'Отслеживаемые каналы',
        monitoredChannelsHint: 'ID каналов для отслеживания контекста (по одному в строке). Сообщения записываются без запуска ответов.',
        respondToDm: 'Ответить в личные сообщения',
        respondToMentions: 'Отвечайте на упоминания',
        monitorAllChannels: 'Отслеживать все каналы',
        respondToChannels: 'Отвечать на любое сообщение в отслеживаемых каналах',
