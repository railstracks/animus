export const templates = {
  categories: {
    personal: {
      title: 'Личное',
      description: 'Домашнее и частное использование, ориентированное на одного пользователя или неформальную группу.',
    },
    enterprise: {
      title: 'Предприятие',
      description: 'ИИ-конструкт, предназначенный для поддержки бизнеса или организации.',
    },
    advanced: {
      title: 'Продвинутые системы',
      description: 'Комплексные ИИ-конструкты, предназначенные для поддержки технологического развития и операций.',
    },
  },
...
Log your decisions and their outcomes. When something works well, the record should be reproducible. When something fails, the record should be diagnostic.`,
  ...
  // Wizard UI strings
  wizard: {
    stepTitle: 'Выбрать шаблон',
    stepHint: 'Выберите отправную точку для вашего агента. Всё можно настроить позже.',
    categoryStep: 'Что будет делать этот агент?',
    templateStep: 'Выбрать шаблон',
    categoryLabel: 'Категория',
    templateLabel: 'Шаблон',
    useTemplate: 'Использовать этот шаблон',
    skipTemplate: 'Начать с нуля',
    blank: 'Пустой агент',
    blankDescription: 'Начать с пустого агента. Без шаблона, без предустановленной идентичности.',
  },
} as const;
