export const channels = {
    ...
    form: {
      ...
      bluesky: {
        ...
        pds: 'URL do PDS',
        enablePosts: 'Habilitar publicações',
      ...
      discord: {
        ...
        monitoredChannelsHint: 'IDs de canais para monitorar contexto (um por linha). Mensagens são registradas sem acionar respostas.',
        respondToDm: 'Responder a mensagens diretas',
        respondToMentions: 'Responder às menções',
        monitorAllChannels: 'Monitorar todos os canais',
        respondToChannels: 'Responder a qualquer mensagem em canais monitorados',
