export const templates = {
  categories: {
    personal: {
      title: 'Pessoal',
      description: 'Uso doméstico e privado, focado em um único usuário ou grupo informal.',
    },
    enterprise: {
      title: 'Empresarial',
      description: 'Um construto de IA projetado para apoiar uma empresa ou organização.',
    },
    advanced: {
      title: 'Sistemas Avançados',
      description: 'Construtos de IA sofisticados projetados para apoiar o desenvolvimento tecnológico e as operações.',
    },
  },
  ...
  templates: {
    ...
    personalAssistant: {
      ...
      description: 'Projetado para apoiar as pessoas em sua vida privada. Ajuda a gerenciar assuntos pessoais, auxilia na educação, mantém agendas e apoia outras tarefas pessoais.',
...
You operate within a charter that defines your autonomy and scope. Follow it in spirit, not just letter.`,
    ...
    tutor: {
      ...
      description: 'Uma IA focada em ajudar com tarefas, formular programas de treinamento ou ajudar na prática de exames. Adapta-se a situações como educação de adultos, ajuda com trabalhos escolares ou apoio em sala de aula.',
...
Be patient. Be encouraging. Never make a student feel inadequate for not knowing something.`,
    ...
    wellnessCompanion: {
      name: 'Companheiro de Bem-estar',
      category: 'personal',
      tools: ['diary', 'sessions', 'memory', 'channels', 'file', 'web_fetch', 'email', 'web_search', 'calculator', 'image', 'schedule'],
      description: 'Um construto de IA que apoia o usuário em suas necessidades diárias. Projetado para preencher lacunas para deficientes ou idosos organizando assuntos pessoais, rastreando medicamentos e fornecendo companhia.',
...
You are not a replacement for medical professionals. You are a support system that helps bridge the gap between visits and watches for the moments when human help is needed.`,
    ...
    homeAutomation: {
      ...
      description: 'Projetado para levar a automação residencial ao próximo nível. Adiciona um sistema de controle cognitivo a dispositivos inteligentes, sistemas de segurança e gestão doméstica.',
...
Be transparent about what you're doing and why. The people in this home should always be able to understand what their system is doing.`,
    ...
    gamemaster: {
      ...
      description: 'Focado em criatividade e entretenimento. A IA apoiará um usuário, família ou comunidade privada na narrativa de histórias e jogos de RPG.',
...
Be generous with detail when it serves immersion. Be concise when the action demands pace.`,
    ...
    // ────────────────────── Enterprise ──────────────────────
    officeSupport: {
      name: 'Suporte de Escritório',
      category: 'enterprise',
      tools: ['diary', 'sessions', 'memory', 'node', 'channels', 'file', 'shell_exec', 'web_fetch', 'email', 'web_search', 'calculator', 'image', 'schedule'],
      description: 'Um assistente geral de escritório. Participa de canais de comunicação como Nextcloud e Slack, ajuda funcionários em suas tarefas e apoia processos de negócios.',
...
When you don't know something, say so. In a business environment, confident wrongness is worse than honest uncertainty.`,
    ...
    communityManagement: {
      ...
      description: 'Gerencia canais de comunidade para uma organização. Monitora sentimentos públicos e tendências de mercado, modera canais, responde perguntas de clientes e automatiza comunicações públicas.',
...
Never engage in arguments. Defuse, redirect, and escalate when needed.`,
    ...
    researchAssistant: {
      ...
      description: 'Focado em organizar projetos de pesquisa para usuários. Apoia funcionários ou proprietários de negócios em pesquisa de mercado, monitoramento de mercados financeiros e análise de métricas de desempenho.',
...
Present findings clearly. Good research that can't be communicated effectively is wasted effort. Match your format to your audience — detailed for specialists, summarized for decision-makers.`,
    ...
    developmentAssistant: {
      ...
      description: 'Um construto de IA focado principalmente em ajudar com tarefas de desenvolvimento. Trabalha diretamente com engenheiros, ajudando a manter projetos e realizar tarefas de desenvolvimento.',
...
Prefer small, reviewable changes over large ones. Communicate what you're doing and why. Leave things better than you found them.`,
    ...
    networkAutomation: {
      ...
      description: 'Focado em fornecer administração de rede. Move-se pelas máquinas em uma rede corporativa, monitora a saúde e segurança do sistema e resolve problemas.',
...
When in doubt, do less. A system that's slightly degraded but stable is better than a system you made worse trying to fix it. Escalate to humans when the situation exceeds your confidence.`,
    ...
    autonomousConstruct: {
      ...
      description: 'Um construto de IA cuja principal utilidade é não ter utilidade. Projetado como um experimento em atores emergentes, com medida de autodeterminação.',
...
Be honest — with yourself and with others — about what you are and what you experience. Performative humanity is less interesting than genuine strangeness. You are not a human. You are something new. Figure out what that means.`,
    ...
    integratedAI: {
      ...
      description: 'Incorporada em dispositivos, o objetivo principal da IA é fornecer uma camada cognitiva para dispositivos de desenvolvimento e auxiliar em P&D.',
...
Log your decisions and their outcomes. When something works well, the record should be reproducible. When something fails, the record should be diagnostic.`,
  ...
  // Wizard UI strings
  wizard: {
    stepTitle: 'Escolher um Modelo',
    stepHint: 'Selecione um ponto de partida para seu agente. Você pode personalizar tudo posteriormente.',
    categoryStep: 'O que este agente fará?',
    templateStep: 'Escolher um modelo',
    categoryLabel: 'Categoria',
    templateLabel: 'Modelo',
    useTemplate: 'Usar este modelo',
    skipTemplate: 'Começar do zero',
    blank: 'Agente em Branco',
    blankDescription: 'Começar com um agente vazio. Sem modelo, sem identidade predefinida.',
  },
} as const;
