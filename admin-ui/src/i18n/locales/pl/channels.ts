export const channels = {
    ...
    form: {
      ...
      discord: {
        ...
        monitoredChannels: 'Śledzone kanały',
        monitoredChannelsHint: 'ID kanałów do śledzenia kontekstu (po jednym w linii). Wiadomości są logowane bez wywoływania odpowiedzi.',
        respondToDm: 'Odpowiadaj na DM',
        respondToMentions: 'Odpowiadaj na wzmianki',
        monitorAllChannels: 'Śledź wszystkie kanały',
        respondToChannels: 'Odpowiadaj na każdą wiadomość w śledzonych kanałach',
        dmWhitelistEnabled: 'Ogranicz DM do dozwolonych użytkowników',
        allowedDmUsers: 'Dozwoleni użytkownicy DM',
        allowedDmUsersHint: 'Nazwy użytkowników Discord (po jednej na linię). Tylko ci użytkownicy mogą wysyłać DM do bota.'
      },
      slack: {
